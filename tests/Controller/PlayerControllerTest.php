...
class PlayerControllerTest extends WebTestCase
{
    ...
    {
        $this->client->request('DELETE', '/player/delete/527d7dad085ed466874e9ee2e6d880ba7cf7f057' . self::$identifier);
        $this->assertJsonResponse();
    }

    public function testBadIdentifier(): void
    {
        $this->client->request('GET', '/player/display/basIdentifier');
        $this->assertError404($this->client->getResponse()->getStatusCode());
    }

    public function testInexistingIdentifier(): void
    {
        $this->client->request('GET', '/player/display/527d7dad085ed466874e9ee2e6d880ba7cf7f057');
        $this->assertError404($this->client->getResponse()->getStatusCode());
    }
